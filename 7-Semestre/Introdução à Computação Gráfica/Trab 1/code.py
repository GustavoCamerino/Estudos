...
nave = None # Objeto 3D da nave
asteroide_origem = None # Objeto 3D do asteroide
...
def display():
    ...
    for ast in asteroids:
        ...
        visualization.draw(asteroide_origem) # Renderiza o asteroide
        glPopMatrix() # Restaura matriz
...
def main():
    global spaceship, asteroide_origem, asteroids
    
    # Carrega modelos 3D (em obj)
    nave = pywavefront.Wavefront('objects/nave.obj')
    asteroide_origem = pywavefront.Wavefront('objects/asteroide_origem.obj')
